        ...
        <g transform="translate(825.000000, 1100.000000)">
          ...
          <g id="Avataaar" stroke-width="1" fill-rule="evenodd" mask="url(#react-mask-5)">
            ...
            <g id="Clothing/Hoodie" transform="translate(0.000000, 170.000000)">
              ...
              <mask id="react-mask-192" fill="white">
                <use xlink:href="#react-path-191"></use>
              </mask>
              <use
                id="Hoodie"
                fill="#B7C1DB"
            ...
            <g id="Top" stroke-width="1" fill-rule="evenodd">
              <defs>
                <rect id="react-path-139" x="0" y="0" width="264" height="280"></rect>
                <path
              ...
              <mask id="react-mask-137" fill="white">
                <use xlink:href="#react-path-139"></use>
              </mask>
              <g id="Mask"></g>
              <g id="Top/Short-Hair/Short-Flat" mask="url(#react-mask-137)">
                <g transform="translate(-1.000000, 0.000000)">
                  <g id="Facial-Hair/Beard-Light" transform="translate(49.000000, 72.000000)">
                    ...
                    <use
                      ...
                      fill="#331B0C"
                      fill-rule="evenodd"
                      xlink:href="#react-path-176"
                    ></use>
                    <g id="Color/Hair/Brown" mask="url(#react-mask-175)" fill="#4A312C">
                      <g transform="translate(-32.000000, 0.000000)" id="Color">
                        <rect x="0" y="0" width="264" height="244"></rect>
                      </g>
                    </g>
                  </g>
                  <mask id="react-mask-136" fill="white">
                    <use xlink:href="#react-path-138"></use>
                  </mask>
                  <use
                    id="Short-Hair"
                    stroke="none"
                    fill="#1F3140"
                    fill-rule="evenodd"
                    xlink:href="#react-path-138"
                  ></use>
                  <g id="Skin/👶🏽-03-Brown" mask="url(#react-mask-136)" fill="#4A312C">
                    <g transform="translate(0.000000, 0.000000) " id="Color">
                      <rect x="0" y="0" width="264" height="280"></rect>
                    </g>
                  </g>
